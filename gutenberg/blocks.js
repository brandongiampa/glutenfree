...
/***/ "./gutenberg/src/blocks/latest-posts.js":
/*!**********************************************!*\
  !*** ./gutenberg/src/blocks/latest-posts.js ***!
  \**********************************************/
...
var selectOptions = Object.keys(glfr_wp.post_categories).map(function (value) {
  return {
    value: glfr_wp.post_categories[value].name,
    label: glfr_wp.post_categories[value].name
  };
});
registerBlockType('glfr/latest-gfb-posts', {
  title: __('GFB Latest Posts', 'glfr'),
  description: __('Provides a list of latest posts that links to post when clicked ANYWHERE', 'glfr'),
  category: 'common',
  icon: "index-card",
  keywords: [__("latest", "glfr"), __("recent", "glfr"), __("post", "glfr"), __("blog", "glfr"), __("recipe", "glfr")],
  supports: {
    html: false
  },
  attributes: {
    ...
    recentPosts: {
      "default": glfr_wp.recent_posts.filter(function (entry) {
  ...
  edit: function edit(props) {
    return [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(PanelBody, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(PanelRow, {
          ...
          options: [{
            value: "All",
            label: "All"
          }].concat(_toConsumableArray(selectOptions)),
          onChange: function onChange(new_val) {
            props.setAttributes({
              selectedCategory: new_val
            });
            props.setAttributes({
              recentPosts: glfr_wp.recent_posts.filter(function (entry) {
      ...
      className: "glfr-block-latest-posts " + props.attributes.className,
      children: props.attributes.recentPosts.filter(function (value, index) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("a", {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
              ...
              children: [props.attributes.showThumbnail === true && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                className: "wp-block-latest-posts__featured-image aligncenter",
              ...
              }), props.attributes.showAuthor === true && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                className: "wp-block-latest-posts__post-author",
                children: value.author
              }), props.attributes.showExcerpt === true && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                className: "wp-block-latest-posts__post-excerpt",
                children: value.excerpt
              })]
            })
          })
        }, index);
